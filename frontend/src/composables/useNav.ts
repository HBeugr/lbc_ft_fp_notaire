...
const ICONS = {
  ...
  gels: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z',
...
// Notaire roles: notaire_principal, responsable_conformite, clercs, admin
type NotaireRole = 'admin' | 'notaire_principal' | 'responsable_conformite' | 'clercs'

const ROLE_ACCESS: Record<string, NotaireRole[]> = {
  dashboard:          ['admin', 'notaire_principal', 'responsable_conformite', 'clercs'],
  kyc:                ['admin', 'notaire_principal', 'responsable_conformite', 'clercs'],
  gel_dossiers:       ['admin', 'notaire_principal', 'responsable_conformite'],
  signalement_alerte: ['admin', 'clercs'],
  risk:               ['admin', 'notaire_principal', 'responsable_conformite'],
  alerts:             ['admin', 'notaire_principal', 'responsable_conformite'],
  dos:                ['admin', 'notaire_principal', 'responsable_conformite'],
  sanctions:          ['admin', 'notaire_principal', 'responsable_conformite'],
...
const ALL_NAV: NavItem[] = [
  ...
  { label: 'Dossiers de Gels',     icon: ICONS.gels,       to: 'gel-dossiers' },
